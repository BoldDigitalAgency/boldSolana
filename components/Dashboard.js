...
export default function Dashboard({logout, user}) {
    ...
    const payWithSolana = async (price) => {
        console.log(price)
    }
    ...
    return(
        <div className=" relative h-screen flex flex-col items-center justify-center py-10 px-4 bg-black overflow-auto">
            <button className="text-white absolute right-72 top-5 bg-pink py-1 px-2 rounded-xl" onClick={logout}>logout</button>
            ...
            <div className="my-10 flex flex-col gap-3">
                ...
                <button className="p-2 rounded-xl bg-green font-semibold hover:text-green hover:bg-blue hover:shadow-white">Pay now !</button>
            </div>
